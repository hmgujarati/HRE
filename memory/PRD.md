...
- **Fix 3 — Enriched list rows**: Each variant's 72-char `description` now shows ₹price + cable mm² + ⌀hole + as many *actually differing* dim keys (auto-picked via `_pick_distinguishing_keys`) as fit under the 72-char limit. Example: `₹5.30 · 4-6 mm² · ⌀8.2 · L1=14 · J=20 · D=12` (44 chars).
